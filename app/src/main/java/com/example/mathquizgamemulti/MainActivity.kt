...
import com.example.mathquizgamemulti.R.*
...
class MainActivity : AppCompatActivity() {
    ...
    private val correctColor: Int by lazy { ContextCompat.getColor(this, color.correctColor) }
    private val incorrectColor: Int by lazy { ContextCompat.getColor(this, color.incorrectColor) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val exitLayout: LinearLayout = findViewById(id.exit)

        val exitButton : Button = findViewById(id.exitbutton)
        val gotohome : Button = findViewById(id.gotohome)
        ...
        startButton = findViewById(id.addition_layout)
        subtractButton = findViewById(id.subtract_button)
        multiplyButton = findViewById(id.multiply_button)
        divisionButton = findViewById(id.division_button)
        randomButton = findViewById(id.random_button)
        gamelayout = findViewById(id.gamelayout)
        dashbord = findViewById(id.dashboard)
        gameover = findViewById(id.gameoverscreen)
        progressBar = findViewById(id.progressBar)
        timerTextView = findViewById(id.timerTextView)
        scoreTextView = findViewById(id.scoreTextView)
        highScoreTextView = findViewById(id.highScoreTextView)
        finalscoretv = findViewById(id.final_score)
        questionNumberTextView = findViewById(id.questionNumberTextView)
        ...
        questionTextView = findViewById(id.questionTextView)
        option1Button = findViewById(id.option1Button)
        option2Button = findViewById(id.option2Button)
        option3Button = findViewById(id.option3Button)
        option4Button = findViewById(id.option4Button)
        timerTextView = findViewById(id.timerTextView)
        progressBar = findViewById(id.progressBar)
        ...
        val playagain =  findViewById<Button>(id.play_again)
    ...
    private fun startGame(selectedOperation: Int) {
        option1Button.setBackgroundResource(drawable.rounded_button_background)
        option2Button.setBackgroundResource(drawable.rounded_button_background)
        option3Button.setBackgroundResource(drawable.rounded_button_background)
        option4Button.setBackgroundResource(drawable.rounded_button_background)
    ...
    fun onOptionSelected(view: View) {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            view.setBackgroundResource(drawable.rounded_button_background)
    ...
    private fun displayHighScore() {
        ...
        val highScore = getStoredHighScore()
    ...
    private fun getStoredHighScore(): Int {
